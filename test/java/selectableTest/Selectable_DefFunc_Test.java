...
public class Selectable_DefFunc_Test extends Hooks {
    ...
    void testSelectableDefFunc(){
        ...
        //6. Verify that Item 5 is selected
        assertTrue(pages.getSelectableDefFuncPage().isTheItemSelectedByIndex(5), "Not able to selected");

        //7. Click on Item 7
        pages.getSelectableDefFuncPage().clickOnElementByIndex(7);

        //8. Verify that Item 7 is selected
        assertTrue(pages.getSelectableDefFuncPage().isTheItemSelectedByIndex(7), "Not able to selected");

        //9. Verify that Item 5 is not selected
        assertFalse(pages.getSelectableDefFuncPage().isTheItemSelectedByIndex(5),"It is still selected");

        //10. Click on Item 1, Item 3, Item 5, Item 6 by holding down the Ctrl key
        pages.getSelectableDefFuncPage().clickOnElementsWithCtrl(1,3,5,6);

        //11. Verify that Item 1, Item 3, Item 5, Item 6 are selected
        assertTrue(pages.getSelectableDefFuncPage().isTheItemSelectedByIndex(1), "Not able to selected");
        assertTrue(pages.getSelectableDefFuncPage().isTheItemSelectedByIndex(3), "Not able to selected");
        assertTrue(pages.getSelectableDefFuncPage().isTheItemSelectedByIndex(5), "Not able to selected");
        assertTrue(pages.getSelectableDefFuncPage().isTheItemSelectedByIndex(6), "Not able to selected");
        ...
        //13. Verify that Item 1, Item 2, Item 3 are selected
        assertTrue(pages.getSelectableDefFuncPage().isTheItemSelectedByIndex(1), "Not able to selected");
        assertTrue(pages.getSelectableDefFuncPage().isTheItemSelectedByIndex(2), "Not able to selected");
        assertTrue(pages.getSelectableDefFuncPage().isTheItemSelectedByIndex(3), "Not able to selected");
